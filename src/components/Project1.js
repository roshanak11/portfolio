    ...
    <section className="hero is-fullheight-with-navbar is-warning">
      <div className="hero-body">
        ...
        Project 1: SNAKE GAME!
          {/* Deployed Project */}
          <h2><a href="https://roshanak11.github.io/project-1-snake-game/" target="_blank" rel="noopener noreferrer">🔗Deployed Project</a></h2>
          {/* GitHub README */}
          <figure className="image is-2by2">
            <a href="https://github.com/roshanak11/project-1-snake-game/blob/main/README.md" target="_blank" rel="noopener noreferrer" alt="ReadMe"><h2>🔗ReadMe</h2>
        ...
        <div className="card-content">
          <p className="has-text-justified">
            I built a grid-based Snake game using HTML, CSS, and JavaScript in three weeks.           </p>
