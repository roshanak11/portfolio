    ...
    <section className="hero is-fullheight-with-navbar is-warning">
      <div className="hero-body">
        ...
        <p className="title is-2 has-text-centered has-text-black">
          Project 2:
          {/* Deployed Project */}
          <h2><a href="https://harry-potter-characters-react-app.netlify.app/" target="_blank" rel="noopener noreferrer">Harry Potter Library</a></h2>
          {/* GitHub README */}
          <figure className="image is-2by2">
            <a href="https://github.com/roshanak11/project-2-hp/blob/main/README.md" target="_blank" rel="noopener noreferrer" alt="ReadMe">
