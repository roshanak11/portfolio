    ...
    <section className="hero is-fullheight-with-navbar is-warning">
      <div className="hero-body">
        ...
        <p className="title is-3 has-text-centered has-text-black">
          Project 2: Harry Potter Library
          {/* GitHub README */}
          <figure className="image is-2by2">
            <a href="https://github.com/roshanak11/project-2-hp/blob/main/README-Roshanak.md" target="_blank" rel="noopener noreferrer" alt="ReadMe"><h2>🔗ReadMe</h2>
          ...
          {/* Deployed Project */}
          <h2><a href="https://harry-potter-characters-react-app.netlify.app/" target="_blank" rel="noopener noreferrer">🔗Deployed Project</a></h2>
          {/* Project Image */}
          <div className="card-image">
            <figure className="image is-2by2">
              <img src="https://res.cloudinary.com/dgicm5dgb/image/upload/v1662543824/Portfolio/HarryPotterLibrary_ypoa64.jpg" alt="Project 2"></img>
            </figure>
          </div>
        </p>
