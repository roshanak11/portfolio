    ...
    <section className="hero is-fullheight-with-navbar is-warning">
      <div className="hero-body">
        ...
        <p className="title is-2 has-text-centered has-text-black">
          Project 4:
          {/* Deployed Project */}
          <h2><a href="https://project-4-shoes-frontend.netlify.app/" target="_blank" rel="noopener noreferrer">Shoe Drip</a></h2>
          {/* GitHub README */}
          <figure className="image is-2by2">
            <a href="https://github.com/roshanak11/project-4-frontend-shoes/blob/main/README.md" target="_blank" rel="noopener noreferrer" alt="ReadMe">
          ...
          <div className="card-image">
            <figure className="image is-2by2">
              <img src="https://res.cloudinary.com/dgicm5dgb/image/upload/v1662542179/Portfolio/ShoeDrip_vsoxmg.jpg" alt="Project 4"></img>
            </figure>
          </div>
        </p>
