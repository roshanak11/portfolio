    ...
    <section className="hero is-fullheight-with-navbar is-warning">
      <div className="hero-body">
        ...
        <p className="title is-2 has-text-centered has-text-black">
          Project 3:
          {/* Deployed Project */}
          <h2><a href="https://isnt-wodnjsd-awesome.netlify.app/" target="_blank" rel="noopener noreferrer">I Beg Your Garden?!</a></h2>
          {/* GitHub README */}
          <figure className="image is-2by2">
            <a href="https://github.com/roshanak11/project-3-frontend/blob/main/README.md" target="_blank" rel="noopener noreferrer" alt="ReadMe">
          ...
          <div className="card-image">
            <figure className="image is-2by2">
              <img src="https://res.cloudinary.com/dgicm5dgb/image/upload/v1662542178/Portfolio/IBegYourGarden_bh4kg8.jpg" alt="Project 3"></img>
            </figure>
          </div>
        </p>
